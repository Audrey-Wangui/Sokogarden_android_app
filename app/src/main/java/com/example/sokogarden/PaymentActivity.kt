...
//        Retrive Data passed from the previous Activity
        val name = intent.getStringExtra("product_name")
        val cost = intent.getIntExtra("product_cost", 0)
//        val description = intent.getStringExtra("Product_descrition")
...
//        Specify the image URL
        val imageUrl = "https://audreywangui.alwaysdata.net/static/images/$product_photo"
...
//            Specify the api endpoint for asking payment
            val api = "https://audreywangui.alwaysdata.net/api/mpesa_payment"
